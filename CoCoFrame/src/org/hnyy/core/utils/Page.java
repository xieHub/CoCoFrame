...
//				sb.append("<input type=\"button\" value="+(i + 1 - first)+" onclick=\"javascript:"+funcName+"("+i+","+pageSize+");\" />\n");
			...
			if (i < begin) {
//				sb.append("<input type=\"button\" class=\"disabled\"  value=\"...\" />\n");
...
//				sb.append("<input type=\"button\" class=\"active\"  value="+ (i + 1 - first)+" />\n");
				sb.append("<li class=\"active\"><a href=\"javascript:\" class=\"cur\">" + (i + 1 - first)
						+ "</a></li>\n");
			} else {
//				sb.append("<input type=\"button\" value="+(i + 1 - first)+" onclick=\"javascript:"+funcName+"("+i+","+pageSize+");\" />\n");
				sb.append("<li><a href=\"javascript:"+funcName+"("+i+","+pageSize+");\">"
...
//			sb.append("<input type=\"button\" value=\"下一页 &#187;\" onclick=\"javascript:"+funcName+"("+next+","+pageSize+");\" />\n");
		...
		sb.append("<li class=\"disabled\"><a href=\"javascript:\">共 " + count + " 条</a></li>\n");
